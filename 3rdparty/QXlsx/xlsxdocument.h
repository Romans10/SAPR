...
public:
	...
	explicit Document(const QString &xlsxName, QObject *parent = NULL);
	explicit Document(QIODevice *device, QObject *parent = NULL);
	~Document();
	...
	bool addSheet(const QString &name = QString(), AbstractSheet::Type type = AbstractSheet::Type::Work);
	bool insertSheet(int index, const QString &name = QString(), AbstractSheet::Type type = AbstractSheet::Type::Work);

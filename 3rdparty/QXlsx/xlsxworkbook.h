...
class Workbook : public AbstractXmlFile
{
...
public:
	...
	AbstractSheet *addSheet(const QString &name = QString(), AbstractSheet::Type type = AbstractSheet::Type::Work);
	AbstractSheet *insertSheet(int index, const QString &name = QString(), AbstractSheet::Type type = AbstractSheet::Type::Work);
...
private:
	...
	AbstractSheet *addSheet(const QString &name, int sheetId, AbstractSheet::Type type = AbstractSheet::Type::Work);
};
